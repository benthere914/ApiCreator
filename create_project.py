...
class Model():
    ...
    def create_Pipfile_file(self):
        Pipfile_lines = []
        Pipfile_lines.append('[[source]]\n')
        Pipfile_lines.append('url = "https://pypi.org/simple"\n')
        Pipfile_lines.append('verify_ssl = true\n')
        Pipfile_lines.append('name = "pypi"\n\n')
        Pipfile_lines.append('[packages]\n')
        Pipfile_lines.append('flask = "*"\n')
        Pipfile_lines.append('gunicorn = "*"\n')
        Pipfile_lines.append('flask-cors = "*"\n')
        Pipfile_lines.append('python-dotenv = "*"\n')
        Pipfile_lines.append('flask-sqlalchemy = "*"\n')
        Pipfile_lines.append('flask-login = "*"\n')
        Pipfile_lines.append('flask-praetorian = "*"\n')
        Pipfile_lines.append('validate-email = "*"\n')
        Pipfile_lines.append('psycopg2-binary = "*"\n')
        Pipfile_lines.append('inflect = "*"\n\n')
        Pipfile_lines.append('[dev-packages]\n\n')
        Pipfile_lines.append('[requires]\n')
        Pipfile_lines.append('python_version = "3.9"\n')
        f = open('Pipfile', 'w')
    ...
    def init_routes(self):
        ...
        f.write('from .auth import auth_routes\n')
        f.close()
